...
mod tests {
    ...
    use lau_scheduling_theory::flow_shop::{FlowShopJob, JohnsonAlgorithm};
    use lau_scheduling_theory::precedence::{PrecedenceConstraint, PrecedenceScheduler};
    use lau_scheduling_theory::resource_constrained::{Resource, ResourceConstrainedScheduler, ResourceJob};
    use lau_scheduling_theory::shop::{OpenShopScheduler, JobShopScheduler, ShopTask, JobShopJob};
    use lau_scheduling_theory::agent_fleet::{Agent, AgentTask, AgentFleetScheduler};
    use lau_scheduling_theory::preemptive::PreemptiveScheduler;
    ...
    #[test]
    fn agent_fleet_respects_specialization() {
        let tasks = vec![
            AgentTask {
                id: 0,
                processing_time: 4.0,
    ...
    #[test]
    fn agent_fleet_capacity_speedup() {
        let tasks = vec![
            AgentTask {
                id: 0,
                processing_time: 4.0,
    ...
    fn agent_fleet_load_balance() {
        ...
        let schedule = AgentFleetScheduler::schedule(&tasks, &agents);
        let balance = AgentFleetScheduler::load_balance(&schedule);
